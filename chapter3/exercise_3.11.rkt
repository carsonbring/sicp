;2024-07-14
;Sweet another graph problem. Not doing it. Here are the answers to the questions it asked besides drawing the graphs
...
;The local states for each new account has its own environment
; The only frame that is chared between different instances is the global environment
