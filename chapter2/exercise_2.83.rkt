...
(define coercion-operation-table (make-table))
(define get-coercion (coercion-operation-table 'lookup-proc))
(define put-coercion (coercion-operation-table 'insert-proc!))
