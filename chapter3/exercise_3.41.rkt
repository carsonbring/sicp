...
;It shouldn't really matter either way because the value is legitamate either way during the time of the balance being retreived and it doesn't change the balance variable at all so it won't impact the other methods. 
